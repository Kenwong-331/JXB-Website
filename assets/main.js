...
const I18N = {
  en: {
    ...
    hero_trust:"Trusted by busy professionals in Setia Alam for efficient EMS training.",
    ...
    why_title:"Why Choose JXB Fit Club",
    why_desc:"Built for people who want guided, efficient, and beginner-friendly EMS training.",
    why1_t:"1-on-1 Coach Guidance",
    why1_d:"Every session is guided to support proper form, safety, and steady progress.",
    why2_t:"Efficient 20-Min Sessions",
    why2_d:"Designed for busy schedules so you can train effectively without spending hours in the gym.",
    why3_t:"Beginner Friendly",
    why3_d:"No experience needed — intensity and pacing are adjusted based on your level.",
    studio_pill:"JXB Studio",
    studio_title:"Private EMS training studio in Setia Alam — designed for efficient 20-minute sessions with coach guidance.",
    studio_desc:"Our EMS studio is designed for efficient 20-minute training sessions with coach guidance, mirror feedback, and a clean training space.",
    ...
    process_title:"How Your First Session Works",
    process_desc:"A simple 3-step process to get started with EMS training.",
    process1_t:"Step 1: Contact Us",
    process1_d:"Message us on WhatsApp and tell us your preferred day, time, and training goal.",
    process2_t:"Step 2: Trial Session",
    process2_d:"Come in for your EMS trial session with coach guidance and adjusted intensity.",
    process3_t:"Step 3: Personalized Plan",
    process3_d:"Based on your goals, we help you choose a suitable training direction or package.",
  ...
  zh: {
    ...
    hero_trust:"深受 Setia Alam 忙碌上班族欢迎，适合想高效训练的人。",
    ...
    why_title:"为什么选择 JXB Fit Club",
    why_desc:"适合想要高效率、有人指导、并且新手也能安心开始的 EMS 训练。",
    why1_t:"教练一对一指导",
    why1_d:"每次训练都有指导，帮助你更好掌握动作、安全训练并稳步进步。",
    why2_t:"20 分钟高效训练",
    why2_d:"为忙碌生活而设计，让你不用花几个小时，也能完成有效训练。",
    why3_t:"新手也适合",
    ...
    process_title:"第一次体验流程",
    process_desc:"简单 3 步，就可以开始你的 EMS 训练。",
    process1_t:"第 1 步：先联系我们",
    process1_d:"通过 WhatsApp 告诉我们你方便的时间，以及你的训练目标。",
    process2_t:"第 2 步：到店体验",
    process2_d:"到店进行 EMS 体验课，由教练带领并根据你的情况调整强度。",
    process3_t:"第 3 步：安排适合你的方案",
    process3_d:"根据你的目标与状态，我们会帮你建议更适合的训练方向或配套。",
    booking_title:"预约方式",
